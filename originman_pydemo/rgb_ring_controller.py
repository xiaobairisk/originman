...
rgb_ring.color_indexs = [buf[0],] * rgb_ring.pixels_num
rgb_ring.saturation = [buf[1],] * rgb_ring.pixels_num
rgb_ring.values = [buf[2],] * rgb_ring.pixels_num

while True:
    rgb_ring.mode1_update()
    time.sleep(0.03)
