...
: ${AMENT_CURRENT_PREFIX:="/userdata/kao.zhu/tros_perc/install/face_age_detection"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/face_age_detection/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/face_age_detection/environment/path.sh"
