...
: ${AMENT_CURRENT_PREFIX:="/userdata/kao.zhu/tros_perc/install/tros_ai_fusion"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tros_ai_fusion/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tros_ai_fusion/environment/path.sh"
