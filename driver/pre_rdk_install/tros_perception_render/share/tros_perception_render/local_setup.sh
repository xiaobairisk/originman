...
: ${AMENT_CURRENT_PREFIX:="/userdata/kao.zhu/tros_perc/install/tros_perception_render"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tros_perception_render/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tros_perception_render/environment/path.sh"
