...
: ${AMENT_CURRENT_PREFIX:="/userdata/kao.zhu/tros_perc/install/tros_lowpass_filter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tros_lowpass_filter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tros_lowpass_filter/environment/path.sh"
